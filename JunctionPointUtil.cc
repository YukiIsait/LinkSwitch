...
void JunctionPoint::Mount(const std::wstring& junctionPoint, const std::wstring& targetDir) {
...
void JunctionPoint::Create(const std::wstring& junctionPoint, const std::wstring& targetDir) {
...
void JunctionPoint::Unmount(const std::wstring& junctionPoint) {
...
void JunctionPoint::Delete(const std::wstring& junctionPoint) {
